...
all:
extra_cflags=-m64 -DUNICORN_HAS_ARM -DUNICORN_HAS_ARMEB -fPIC -O3 -g -DNDEBUG -march=native -fvisibility=hidden
extra_ldflags=
ARCH=x86_64
STRIP=strip
CONFIG_POSIX=y
CONFIG_LINUX=y
SRC_PATH=/home/user/Desktop/web/backend/fuzzers/fuzzware/emulator/unicorn/fuzzware-unicorn/qemu
